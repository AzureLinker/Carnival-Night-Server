...
class GamesController {
    ...
    async updateGames (req, res) {
        ...
        const user = await db.query(`UPDATE Games set Name_of_the_game = $Name_of_the_game, Description_of_the_game = $Description_of_the_game, Path_to_the_directory = $Path_to_the_directory, idGames = $idGames RETURNING *`, [Name_of_the_game, Description_of_the_game, Path_to_the_directory, idGames] )
